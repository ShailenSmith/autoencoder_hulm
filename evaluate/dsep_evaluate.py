...
non_dsep_model_path = base_model_path + "non_dsep_model/checkpoint-45550"
wandb_test_path = base_model_path + "steps_test"

os.environ["WANDB_PROJECT"] = "dsep_evaluations"

if True:
    data_paths = [sample_chunked_dsep_path, sample_chunked_path]
    model_paths = [dsep_model_path, non_dsep_model_path]
    run_names = ["dsep", "non_dsep"]
