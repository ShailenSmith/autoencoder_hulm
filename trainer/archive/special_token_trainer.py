...
def main():
    ...
    docss_train_params = TrainParams(
        data_path=base_data_path + "sample_chunked_docss_4096",
        model_path=base_model_path + docss_run_name,
        run_name=docss_run_name,
        pos_embd_strat="load_repeat",
        lr=1.6e-4,
        attn_dropout=0.105,
        weight_decay=7e-3,
    ...
    # train
    for train_params in [docss_train_params, dsep_train_params]:
        train(train_params)
        print("\n\n------\n\n------\n\n")
        time.sleep(60)
