...
def main():
    ...
    load_repeat_run_name = "load_repeat_model"

    no_load_train_params = TrainParams(
    ...
    load_512_train_params = TrainParams(
        data_path=base_data_path + "sample_chunked_dsep_4096",
    ...
    load_repeat_train_params = TrainParams(
        data_path=base_data_path + "sample_chunked_dsep_4096",
        model_path=base_model_path + load_repeat_run_name,
        run_name=load_repeat_run_name,
    ...
    # set wandb project
    os.environ["WANDB_PROJECT"] = "special_token_experiment"

    # pick GPU with memory available
    pick_gpu()

    # train
    for train_params in [load_512_train_params, no_load_train_params, load_repeat_train_params]:
        train(train_params)
        print("\n\n------\n\n------\n\n")
        time.sleep(60)
