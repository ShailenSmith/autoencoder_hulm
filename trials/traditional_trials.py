...
def run_trials(data_path, model_path, run_name):
    ...
    def optuna_hp_space(trial):
        return {
            ...
            "weight_decay": trial.suggest_categorical("weight_decay",  [0.02, 0.06, 0.1]),
...
unchunked_512_path = base_data_path + f"_sample_dses/unchunked_512_sample"
control_model_path = base_model_path + "may_control_trials"
